...
\restrict 3XC7Ef2kAZCPsqL5ubtVyVi3RfxgMHRdd0YXyL0hplSpO1ROz6HitSGaM8h1LZd
...
5	BSc Informatics Engineering — AI Major	Arab International University	Damascus, Syria	Sep 2015 — Mar 2021	Thesis: Human Behavior Simulation — a multi-modal AI system combining voice cloning, 3D avatar reconstruction, and deep RL agent training.	["<span class=\\"accent-hl\\">Voice Cloning </span>via Zero-Shot Learning from 5-20s audio samples", "<span class=\\"accent-hl\\">3D Avatar Reconstruction</span> using Facebook's PIFu from a single image", "<span class=\\"accent-hl\\">RL Agent </span>trained to walk in Blender/Unity via PPO"]	5
...
2	AI Engineer (Freelance)	Freelance	Remote	Apr 2021 — Oct 2022	Delivered end-to-end AI solutions for diverse clients, managing every stage from scoping to deployment and maintenance.	["<span class=\\"accent-hl\\">'Virtual Patient'</span> simulation for interactive medical training", "Automated <span class=\\"accent-hl\\">Dark Web Auto-Labelling &amp; Classification</span> system"]	2
\.
...
SELECT pg_catalog.setval('public.page_visits_id_seq', 101, true);
...
\unrestrict 3XC7Ef2kAZCPsqL5ubtVyVi3RfxgMHRdd0YXyL0hplSpO1ROz6HitSGaM8h1LZd
